                ...
                <>
                    <div className="card-left">
                        {usersData.map((user) => {
                            if (user._id === post.posterId) {
                                return (
                                    <img src={`https://delagram-app-api.onrender.com/client/public/uploads/profil/${user.picture}`} alt="test" className="pseudo-pic"></img>
                                )
                            }
                            return null
                        })}
                    ...
                    <div className="card-right">
                        ...
                        {post.picture && <img src={`https://delagram-app-api.onrender.com/client/public/uploads/posts/${post.picture}`} alt="card-pic" className="card-pic"></img>}
                        {post.video && (
                            <iframe width="500" height="300" src={`https://delagram-app-api.onrender.com/client/public/uploads/posts/${post.video}`} title={post._id} frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullscreen></iframe>
                        )}
