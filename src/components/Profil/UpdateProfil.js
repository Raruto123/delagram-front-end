        ...
        <div className="profil-container">
            <div className="update-container">
                <div className="left-part">
                    <h3>{userPseudo}</h3>
                    <img src={`https://delagram-app-api.onrender.com/client/public/uploads/profil/${userPicture}`} alt="user-pic"></img>
                    <UploadImg></UploadImg>
                    <p>{error.maxSize}</p>
                    <p>{error.format}</p>
                </div>
                            ...
                            {usersData.users.map((user) => {
                                for (let i = 0; i < userData.following.length; i++) {
                                    if (user._id === userData.following[i]) {
                                        return(
                                            <li key={user._id}>
                                                <img src={`https://delagram-app-api.onrender.com/client/public/uploads/profil/${user.picture}`} alt="user-pic"></img>
                                                <h4>{user.pseudo}</h4>
